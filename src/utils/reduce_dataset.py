...
# split = "_summer"
# path_read = os.path.join(url_data,"dataset_summer_split_13")
# n_high = [2280,6420,2930,4560,7679,6529,9046,5008,5775,2052]

years_winter = ["2008","2009",\
          "2010","2011","2012","2013","2014","2015","2016","2017","2019","2020"]
split = "_winter"
path_read = os.path.join(url_data,"dataset_winter_split_13")
n_high = [3154,4816,3102,2883,5883,17307,6462,6941,2030,7274,7929,3441]
...
for index,year in enumerate(years_winter):
    ...
    for kind in kinds:
        ...
        new_df.write_csv(os.path.join(url_data,"cut_winter_13",f"{year}_{range_cut}_{kind}_cut.csv"))
